...
var examples map[string]func() = map[string]func(){
	...
	"ProjectileExample":         func() { RunProjectileExample() },
	"DrawProjectileExample":     func() { RunDrawProjectileExample() },
	"MatrixExample":             func() { RunMatrixExample() },
	"AnalogClockExample":        func() { RunDrawAnalogClockExample() },
	"SphereSilhouette":          func() { RunDrawSphereSilhouette(false, true, true, true) },
	"SphereShaded":              func() { RunDrawSphereShaded(false, true, true, true) },
	...
	// "WorldWithReflection":              func() { RunDrawWorldWithReflection() },
	// "WorldWithReflectionAndRefraction": func() { RunDrawWorldWithReflectionAndRefraction() },
	// "WorldWithRefraction":         func() { RunDrawWorldWithRefraction() },
	"WorldWithCube":  func() { RunDrawWorldWithCube() },
	"WorldWithTable": func() { RunDrawWorldWithTable() },
	// "WorldInsideShape":            func() { RunDrawWorldInsideShape() },
