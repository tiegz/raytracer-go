...
func RunDrawWorldWithMultiplePatterns() {
	...
	floor.Material.Pattern = raytracer.NewCheckerPattern(raytracer.Colors["White"], raytracer.Colors["Red"])
	...
	rightSphere.Material.Pattern.Transform = raytracer.NewScale(0.23, 0.23, 0.23)
	...
	leftSphere.Material.Pattern = raytracer.NewCheckerPattern(raytracer.Colors["White"], raytracer.Colors["Black"])
